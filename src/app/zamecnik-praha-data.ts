...
export const prahaData: Record<string, PrahaData> = {
  '1': {
    ...
    imageAlt: 'Zámečník Praha 1 - Rychlý zásah na Starém Městě a v centru',
  ...
  '4': {
    ...
    imageAlt: 'Pohotovostní zámečník Praha 4 - Pankrác a Nusle',
  ...
  '10': {
    ...
    imageAlt: 'Zámečník Praha 10 - Vršovice a náměstí Svatopluka Čecha',
